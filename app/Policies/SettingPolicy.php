...
class SettingPolicy
{
    ...
    {
        return $user->can('force_delete_dashboard::setting');
    }
    ...
    {
        return $user->can('force_delete_any_dashboard::setting');
    }
    ...
    {
        return $user->can('restore_dashboard::setting');
    }
    ...
    {
        return $user->can('restore_any_dashboard::setting');
    }
    ...
    {
        return $user->can('replicate_dashboard::setting');
    }
    ...
    {
        return $user->can('reorder_dashboard::setting');
    }
}
